...
const Contact = () => {
  return (
    <div className="min-h-screen">
      ...
      {/* Free Film Offer Section */}
      <section className="py-20 relative">
        <div className="container px-6 relative z-10">
          <div className="max-w-4xl mx-auto glass-card rounded-3xl p-8 md:p-12">
            <div className="text-center">
              <h2 className="text-2xl md:text-3xl font-bold mb-4">Get Free Access to "A Different Corner"</h2>
              <p className="text-muted-foreground max-w-2xl mx-auto mb-6">
                Sign up for my newsletter to receive updates on AI integration strategies and get free access to my feature film "A Different Corner".
              </p>
