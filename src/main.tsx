...
const APP_VERSION = '2025.03.30.28'; // Updated version ID to force cache invalidation
...
// Fixed: Call setTimeout with a callback function that calls mountApp, not directly passing mountApp
